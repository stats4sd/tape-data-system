...
return new class () extends Migration {
    ...
    public function up(): void
    {
        Schema::create('main_surveys', function (Blueprint $table) {
            ...
            $table->decimal('ag_men')->nullable();
            $table->decimal('ag_women')->nullable();
            $table->decimal('ag_myoung')->nullable();
            $table->decimal('ag_fyoung')->nullable();
            $table->decimal('ag_children')->nullable();
            $table->text('area_unit')->nullable();
            $table->decimal('area')->nullable();
            $table->decimal('area_ha')->nullable();
            $table->decimal('area_natural_veg')->nullable();
            $table->decimal('area_natural_veg_ha')->nullable();
            $table->decimal('area_permanent_pasture')->nullable();
            $table->decimal('area_permanent_pasture_ha')->nullable();
            $table->decimal('area_common_pasture')->nullable();
            $table->decimal('area_common_pasture_ha')->nullable();
            ...
            $table->decimal('feedexp_total')->nullable();
            $table->decimal('vetexp_total')->nullable();

            $table->text('anprodnum')->nullable();

            $table->integer('activnum')->nullable();

            $table->decimal('foodexp')->nullable();
            $table->decimal('seedsexp')->nullable();
            $table->decimal('fertexp')->nullable();
            $table->decimal('livexp')->nullable();
            ...
            $table->decimal('days_ext')->nullable();
            $table->integer('wage_season')->nullable();
            $table->integer('machnum')->nullable();
            $table->decimal('machexp')->nullable();

            $table->decimal('fuelexp')->nullable();
            $table->decimal('enerexp')->nullable();
            $table->decimal('machrentexp')->nullable();
            $table->decimal('transpexp')->nullable();
            $table->decimal('rentcost')->nullable();
            ...
            $table->decimal('cp_exp')->nullable();
            $table->integer('opestnum')->nullable();


            $table->decimal('op_exp')->nullable();
            ...
            $table->decimal('sum_diversity')->nullable();
            $table->decimal('stand_diversity')->nullable();
            $table->text('cla_int')->nullable();
            $table->text('s_plant')->nullable();
            $table->text('tree_int')->nullable();
            $table->text('connectivity')->nullable();
            $table->decimal('sum_syn')->nullable();
            $table->decimal('stand_syn')->nullable();
            $table->text('rec_biomass')->nullable();
            $table->text('waste')->nullable();
            $table->text('water')->nullable();
            $table->text('ren_energy')->nullable();
            $table->decimal('sum_rec')->nullable();
            $table->decimal('stand_rec')->nullable();
            $table->text('ext_inp')->nullable();
            $table->text('soil_fert')->nullable();
            $table->text('pest_dis')->nullable();
            $table->decimal('emergingefficiency')->nullable();
            $table->decimal('sum_eff')->nullable();
            $table->decimal('stand_eff')->nullable();
            $table->text('vuln')->nullable();
            $table->text('indebt')->nullable();
            $table->decimal('averdiv')->nullable();
            $table->decimal('averself-suff-empowerment')->nullable();
            $table->decimal('sum_res')->nullable();
            $table->decimal('stand_res')->nullable();
            $table->text('diet')->nullable();
            $table->text('food-self-suff')->nullable();
            $table->text('food-heritage')->nullable();
            $table->text('seeds_breeds')->nullable();
            $table->decimal('sum_cultfood')->nullable();
            $table->decimal('stand_cultfood')->nullable();
            $table->text('ae_know')->nullable();
            $table->text('platforms')->nullable();
            $table->text('partic_orgs')->nullable();
            $table->decimal('sum_cocrea')->nullable();
            $table->decimal('stand_cocrea')->nullable();
            $table->text('women')->nullable();
            $table->text('labour')->nullable();
            $table->text('youth')->nullable();
            $table->text('animalwel')->nullable();
            $table->decimal('coalanwel')->nullable();
            $table->decimal('sum_human')->nullable();
            $table->decimal('stand_human')->nullable();
            $table->decimal('sum_human1')->nullable();
            $table->decimal('stand_human1')->nullable();
            $table->text('mkt_local')->nullable();
            $table->text('networks')->nullable();
            $table->text('local_fs')->nullable();
            $table->decimal('sum_circular')->nullable();
            $table->decimal('stand_circular')->nullable();
            $table->text('prod_empow')->nullable();
            $table->text('prod_orgs')->nullable();
            $table->text('partic_prod')->nullable();
            $table->decimal('sum_respgov')->nullable();
            $table->decimal('stand_respgov')->nullable();
            $table->decimal('totscore_caet')->nullable();
            $table->decimal('totscore_caet1')->nullable();
